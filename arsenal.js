...
const WEAPONS = Object.freeze({
  rifle: Object.freeze({
    ...
    kickSnap:2.8, kickImpulse:130, kickSpring:21, maxKick:7, climbSnap:.032, climbImpulse:.95, climbSpring:9, maxClimb:.15, impactImpulse:260, impactStop:.032, shotStop:.012, cameraSnap:1.6, heatPerShot:.14,
    barrelLength:50, gripX:32, triggerX:13, stockLength:15,
    color:'#704020', metal:'#353b32', shellColor:'#d3b66b', shotSound:'shot',
    cameraKick:34, shake:2.2, projectileSpeed:1050, range:900, pelletFalloff:false
  }),
  smg: Object.freeze({
    ...
    kickSnap:1.6, kickImpulse:78, kickSpring:25, maxKick:5.5, climbSnap:.018, climbImpulse:.5, climbSpring:11, maxClimb:.11, impactImpulse:150, impactStop:.019, shotStop:.006, cameraSnap:.85, heatPerShot:.09,
    barrelLength:36, gripX:25, triggerX:11, stockLength:13,
    color:'#3d4947', metal:'#282e2c', shellColor:'#bfa468', shotSound:'smg',
    cameraKick:19, shake:1.4, projectileSpeed:1000, range:750, pelletFalloff:false
  }),
  shotgun: Object.freeze({
    ...
    kickSnap:5.8, kickImpulse:215, kickSpring:18, maxKick:11, climbSnap:.085, climbImpulse:1.8, climbSpring:8, maxClimb:.25, impactImpulse:140, impactStop:.052, shotStop:.027, cameraSnap:3.2, heatPerShot:.36,
    barrelLength:56, gripX:35, triggerX:14, stockLength:19,
    color:'#8d5130', metal:'#39403c', shellColor:'#9e3024', shotSound:'shotgun',
    cameraKick:62, shake:4.5, projectileSpeed:1060, range:560, pelletFalloff:true,
    pumpDuration:.3
  }),
  pistol: Object.freeze({
    ...
    impactImpulse:380, impactStop:.041, shotStop:.018, cameraSnap:2.1, heatPerShot:.19,
    barrelLength:21, gripX:8, triggerX:4, stockLength:4,
    color:'#6c4833', metal:'#535950', shellColor:'#c7a362', shotSound:'pistol',
    cameraKick:41, shake:2.8, projectileSpeed:1060, range:820, pelletFalloff:false
  }),
  crowbar: Object.freeze({
    ...
    impactImpulse:520, impactStop:.09, shotStop:0, cameraSnap:.8, heatPerShot:0,
    barrelLength:40, gripX:11, triggerX:3, stockLength:0,
    color:'#923c2d', metal:'#899087', shellColor:'#899087', shotSound:'swing',
    cameraKick:23, shake:3.5, projectileSpeed:0, pelletFalloff:false
  })
});
